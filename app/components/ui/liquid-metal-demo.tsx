...
const PARAM_KEYS = ["colorBack","colorTint","shape","repetition","softness","shiftRed","shiftBlue","distortion","contour","angle","speed","scale","rotation","offsetX","offsetY","fit"];
...
const DEFAULTS = pickParams(liquidMetalPresets[0].params as Record<string, unknown>);
  ...
  return (
    ...
    >
      <div style={{ flex: 1, minHeight: 480, display: "flex", minWidth: 0 }}>
        <Suspense fallback={<div style={{ flex: 1, background: "rgba(0,0,0,0.05)" }} />}>
          <LiquidMetal {...(params as object)} image={image} suspendWhenProcessingImage style={{ width: "100%", height: "100%" }} />
        </Suspense>
      </div>
