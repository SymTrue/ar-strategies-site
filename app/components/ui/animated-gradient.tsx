...
export function AnimatedGradient({
    ...
    void main() {
      gl_Position = a_position;
            ...
            const fragmentShaderSource = isWebGL2 ? FRAGMENT_SHADER : FRAGMENT_SHADER_WEBGL1;
...
// Fragment shader compatible with both WebGL 1 and WebGL 2
// When used with WebGL 1, the #version line is ignored
...
// WebGL 1.0 compatible fragment shader
